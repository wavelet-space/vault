...
Nejprve fitujeme naivní model, který nezohledňuje prostorové autokorelace. V tomto modelu vzchází efekt odrůdy jako vysoce průkazný. Residuály však vzkazují jasnou prostorou závislost, v určitých oblastech studované plochy model intenzitu infekce systematicky podhodnocuje a jinde zas nadhodnocuje. I když se Moran s I neliší oproti očekáváni, prostorová autokorelace residuí je dobře vidět i na semivariagramu. 
